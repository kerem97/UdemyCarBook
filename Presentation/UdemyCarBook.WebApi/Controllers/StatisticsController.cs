...
namespace UdemyCarBook.WebApi.Controllers
{
    ...
    public class StatisticsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCarCount()
        {
            ...
            return Ok(new { carCount = result.CarCount });
        }
        ...
        {
            var values = await _mediator.Send(new GetAvgDailyCarPriceAmountQuery());
            return Ok(values);
        }
        ...
        {
            var values = await _mediator.Send(new GetAvgWeeklyCarPriceAmountQuery());
            return Ok(values);
        }
        ...
        {
            var values = await _mediator.Send(new GetAvgMonthlyCarPriceAmountQuery());
            return Ok(values);
        }
